    ...
    <main class="container mx-auto px-4 py-8">
      ...
      <div v-else>
            ...
            <div v-else class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                  <tr>
                    <th scope="col"
                      class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Title</th>
                    <th scope="col"
                      class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                    <th scope="col"
                      class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Priority
                    </th>
                    <th scope="col"
                      class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Due Date
                    </th>
                    <th scope="col"
                      class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Notes</th>
                    <th scope="col"
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="task in dueTasks" :key="task.id" :class="{
        ...
        <div class="mt-8">
          ...
          <div v-if="isLoading" class="text-gray-600">Loading tasks...</div>
          <div v-else-if="completedTasks.length === 0" class="text-gray-600 bg-white p-6 rounded-lg shadow-sm">No
            recently
            completed tasks</div>
          <div v-else class="bg-white p-6 rounded-lg shadow-sm overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="task in completedTasks" :key="task.id" class="bg-green-50 hover:bg-green-100">
                  <td class="px-4 py-3 whitespace-nowrap">
                    <div class="font-medium text-gray-900">{{ task.title }}</div>
                  </td>
                  <td class="px-4 py-3 whitespace-nowrap">
